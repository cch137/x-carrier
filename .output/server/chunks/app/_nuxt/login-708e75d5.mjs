import { defineComponent, useAttrs as useAttrs$1, useSlots, computed, shallowRef, ref, watch, nextTick, toRef, withDirectives, openBlock, createElementBlock, mergeProps, unref, createCommentVNode, Fragment, normalizeClass, renderSlot, createElementVNode, createBlock, withCtx, resolveDynamicComponent, withModifiers, createVNode, toDisplayString, normalizeStyle, vShow, isRef, createTextVNode, useSSRContext, getCurrentInstance } from 'vue';
import { useResizeObserver, useEventListener, isClient } from '@vueuse/core';
import { isNil, fromPairs } from 'lodash-unified';
import { b as buildProps, u as useNamespace, V as ValidateComponentsMap, v as view_default, h as hide_default, i as debugWarn, E as ElIcon, j as circle_close_default, w as withInstall, a as useAuth, c as useTitle, k as useSizeProp, l as definePropType, m as iconPropType, n as mutable, g as appName, o as isNumber, _ as _export_sfc } from './app-0c3f4cab.mjs';
import { NOOP, isString, isObject } from '@vue/shared';
import { b as useFormItem, c as useFormItemInputId, u as useFormSize, d as useFormDisabled, E as ElLoading, a as ElButton } from './el-button-de390d68.mjs';
...
var Input = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/input/src/input.vue"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function focusPinInput() {
      try {
        document.querySelector(".LoginPinInput input").focus();
      } catch {
      }
    }
...
//# sourceMappingURL=login-708e75d5.mjs.map
